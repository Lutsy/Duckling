...
public class BookV2 : MonoBehaviour {
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        Left.material = (currentPage < bookPages.Length) ? bookPages[currentPage] : background;
        Left.transform.SetAsFirstSibling();
        
        Right.gameObject.SetActive(true);
        Right.transform.position = RightNext.transform.position;
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.material = (currentPage < bookPages.Length - 1) ? bookPages[currentPage + 1] : background;

        RightNext.material = (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2] : background;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        Right.material = bookPages[currentPage - 1];
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.transform.SetAsFirstSibling();
        ...
        Left.transform.eulerAngles = new Vector3(0, 0, 0);
        Left.material = (currentPage >= 2) ? bookPages[currentPage - 2] : background;

        LeftNext.material = (currentPage >= 3) ? bookPages[currentPage - 3] : background;
    ...
    void UpdateSprites()
    {
        LeftNext.material = (currentPage > 0 && currentPage <= bookPages.Length) ? bookPages[currentPage-1] : background;
        RightNext.material =(currentPage>=0 &&currentPage<bookPages.Length) ? bookPages[currentPage] : background;
    }
