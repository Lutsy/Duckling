...
public class Book : MonoBehaviour {
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        Left.material = (currentPage < bookPages.Length) ? bookPagesMat[currentPage] : backgroundMat;
        Left.transform.SetAsFirstSibling();
        ...
        Right.material = (currentPage < bookPages.Length - 1) ? bookPagesMat[currentPage + 1] : backgroundMat;
        RightNext.material = (currentPage < bookPages.Length - 2) ? bookPagesMat[currentPage + 2] : backgroundMat;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        Right.material = bookPagesMat[currentPage - 1];
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.transform.SetAsFirstSibling();
        ...
        Left.material = (currentPage >= 2) ? bookPagesMat[currentPage - 2] : backgroundMat;
        LeftNext.material = (currentPage >= 3) ? bookPagesMat[currentPage - 3] : backgroundMat;
    ...
    void UpdateSprites()
    {
        ...
        LeftNext.material= (currentPage > 0 && currentPage <= bookPages.Length) ? bookPagesMat[currentPage-1] : backgroundMat;
        RightNext.material=(currentPage>=0 &&currentPage<bookPages.Length) ? bookPagesMat[currentPage] : backgroundMat;
    }
